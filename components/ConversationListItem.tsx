        ...
        >
            ...
            <div className="flex-grow min-w-0">
                ...
                <div className="flex justify-between items-center">
                    <p className={`text-xs truncate max-w-[85%] ${isParticipantTyping ? 'text-cyan-400 font-medium' : hasUnread ? 'text-gray-100 font-medium' : 'text-gray-500'}`}>
                        {isParticipantTyping ? (
                            <span className="flex items-center gap-1 animate-pulse text-cyan-400 font-medium">
