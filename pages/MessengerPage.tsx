...
const MessengerPage: React.FC<MessengerPageProps> = ({ conversations, onSendMessage, onDeleteMessage, onSetTyping, onCreateConversation, userCreations, allUsers, initialConversationId, onClearInitialConversation, onSaveMeme }) => {
