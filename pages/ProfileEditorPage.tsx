        ...
        <div className="min-h-screen container mx-auto px-4 py-8 animate-fadeIn">
            ...
            <div className="bg-gray-900/50 border border-violet-500/30 rounded-lg p-6 max-w-2xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label htmlFor="nationality" className="block text-sm font-medium text-gray-300 mb-2">Location / Nationality</label>
                        <input type="text" id="nationality" name="nationality" value={formData.nationality || ''} onChange={handleInputChange} placeholder="e.g. Canada" className="w-full bg-gray-800/60 border border-violet-500/30 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500" />
                    </div>
                </div>
